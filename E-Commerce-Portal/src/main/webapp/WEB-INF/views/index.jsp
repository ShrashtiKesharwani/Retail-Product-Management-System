		...
		<div class="card-columns">
			...
			<c:forEach var="item" items="${list}">
				<div class="card my-4 mx-4">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">${item.name} <a href="#" class="badge badge-success"><span id="rating">${item.rating}</span></a></h5>
                                <h6 class="card-subtitle mb-2">Rs. ${item.price}</h6>
                                <h6 class="card-subtitle mb-2 date_field">Expected Date:<span class="date">12/10/2020</span></h6>
                                ...
                                <span id="resultSpan"></span>
                                    <button class="btn btn-primary btn-block addcart" id="" data-toggle="modal"
                                        data-target="#myModal" onClick="configureProductId(${item.id})">Add to Cart</button>

                                    <button class="btn btn-danger btn-block addcart" id="${item.id}"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
						    <div class="input-group">
						        ...
						        <button class="btn btn-warning btn-block addcart" data-dismiss="modal"  onClick="addToCart()">Add
						            to Cart</button>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="input-group">
								...
								<button class="btn btn-warning btn-block addcart" data-dismiss="modal"
